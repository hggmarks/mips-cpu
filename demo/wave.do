...
add wave -noupdate /cpu/DIV_/dividendo
add wave -noupdate /cpu/DIV_/divisor
add wave -noupdate /cpu/DIV_/mflo
add wave -noupdate /cpu/DIV_/mfhi
add wave -noupdate /cpu/DIV_/excessao
add wave -noupdate /cpu/DIV_/div_init
add wave -noupdate /cpu/DIV_/div_end
add wave -noupdate /cpu/DIV_/quociente
add wave -noupdate /cpu/DIV_/resto
add wave -noupdate /cpu/DIV_/DIVIDENDO
add wave -noupdate /cpu/DIV_/DIVISOR
add wave -noupdate /cpu/DIV_/count
add wave -noupdate /cpu/DIV_/negative_dividendo
add wave -noupdate /cpu/DIV_/negative_divisor
add wave -noupdate /cpu/MEM_TO_REG_/sel
add wave -noupdate /cpu/MEM_TO_REG_/shift_reg
add wave -noupdate /cpu/MEM_TO_REG_/lo
add wave -noupdate /cpu/MEM_TO_REG_/hi
add wave -noupdate /cpu/MEM_TO_REG_/load_size
add wave -noupdate /cpu/MEM_TO_REG_/sign_extend
add wave -noupdate /cpu/MEM_TO_REG_/alu_out
add wave -noupdate /cpu/MEM_TO_REG_/saida
...
add wave -noupdate /cpu/ULA_/Menor
...
WaveRestoreCursors {{Cursor 1} {5132 ps} 0}
...
update
WaveRestoreZoom {4752 ps} {5307 ps}
view wave 
...
wave modify -driver freeze -pattern clock -initialvalue St1 -period 100ps -dutycycle 50 -starttime 0ps -endtime 9000ps Edit:/cpu/clk 
wave modify -driver freeze -pattern constant -value St0 -starttime 0ps -endtime 9000ps Edit:/cpu/reset 
