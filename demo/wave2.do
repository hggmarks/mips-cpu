...
add wave -noupdate /cpu/CONTROL_UNIT_/MultEnd
add wave -noupdate /cpu/MULT_/multiplicando
add wave -noupdate /cpu/MULT_/multiplicador
add wave -noupdate /cpu/MULT_/mflo
add wave -noupdate /cpu/MULT_/mfhi
add wave -noupdate /cpu/MULT_/mult_init
add wave -noupdate /cpu/MULT_/mult_end
add wave -noupdate /cpu/MULT_/count
add wave -noupdate /cpu/MULT_/produto
...
wave create -driver freeze -pattern clock -initialvalue 1 -period 100ps -dutycycle 50 -starttime 0ps -endtime 10000ps sim:/cpu/clk 
wave create -driver freeze -pattern constant -value 0 -starttime 0ps -endtime 10000ps sim:/cpu/reset 
wave edit change_value -start 0ps -end 104ps -value 1 Edit:/cpu/reset 
WaveCollapseAll -1
